...
export const useActionStore = defineStore('action', () => {
    ...
    const findActionAncestorChain = (
        ...
        if (action) {
            ...
            console.error(`ActionStore "findActionAncestorChain": Cannot find action by ${field}: ${String(key)}`);
            return undefined;
        }
    };
     ...
     * @param actionTree
     */
    const preprocessActionTree = (dataTree: any): ActionItem[] => {
    ...
    return {
        ...
        getActions,
        findAction,
        findActionAncestorChain,
        preprocessActionTree,
        $reset,
    }
});
